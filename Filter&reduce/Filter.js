...
{ title: 'Book Eight', genre: 'Science', publish: 2011, edition: 2000 }, 
]

const userBooks = books.filter((bk) => bk.genre === 'History')

let userBooks1 = books.filter((rk) => rk.publish >= "2000")

let userBooks2 = books.filter((gk) => {
    return gk.publish >= 1990 && gk.genre === 'History'
})
